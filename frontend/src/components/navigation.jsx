...
const Navigation = ({ activePage, setActivePage }) => {
    ...
    return(
        <div className="p-4 rounded-full bg-white flex flex-row gap-4 drop-shadow-lg">
            ...
            {/* HOME */}
            <div 
                className={`${isActive(pages[1]) ? 'bg-[#DADADA]' : null} p-8 flex flex-row gap-4 items-center justify-between cursor-pointer rounded-full hover:bg-[#DADADA]`}
            ...
            {/* SETTINGS */}
            <div 
                className={`${isActive(pages[2]) ? 'bg-[#DADADA]' : null} p-8 flex flex-row gap-4 items-center justify-between cursor-pointer rounded-full hover:bg-[#DADADA]`}
